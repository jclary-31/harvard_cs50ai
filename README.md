...
if windows, create a virtual environnement with command 'python3 -m venv .venv'


### Course
Artificial Intelligence (AI) covers a range of algorithms mimicking human behaviour. The courses and the problems explore some of the ideas that make AI possible. Here are the 

0. **[Search](https://cs50.harvard.edu/ai/weeks/0/)**: Find the best route between two points, explore possibilities to beat another player in a game
1. **[Knowledge](https://cs50.harvard.edu/ai/weeks/1/)**: Represent information, create logical relationship, infer new knowledges with entailment
...
my certification : https://courses.edx.org/certificates/8b5e9de85d50482bb8f1239131bc324a
